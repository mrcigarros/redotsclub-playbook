  ...
  async function submitQuiz() {
    ...
    try {
      await fetch('https://api.emailjs.com/api/v1.0/email/send', {
        ...
        body: JSON.stringify({
          service_id: 'service_63dw4ef',
          template_id: 'template_quizzanswers',
          user_id: 'sC4itXDXvwmQFC96r',
          template_params: {
              ...
              <div className="hero">
                ...
                <div className="hero-stats">
                  {[
                    ...
                    {num:'500',  label: tl('Members by Dec 2026','Membros até Dez 2026','Miembros para Dic 2026','2026年12月前會員')},
                    {num:'25',   label: tl('Chapters by Dec 2026','Capítulos até Dez 2026','Capítulos para Dic 2026','2026年12月前分部')},
                  ].map(s=>(
